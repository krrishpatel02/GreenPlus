            ...
            {resetConfirm ? (
              ...
              <button
                onClick={() => setResetConfirm(true)}
                  className="profile-reset-button w-full sm:w-auto px-4 py-2 bg-red-50 hover:bg-red-100 border border-red-200 text-red-700 text-xs font-bold rounded-xl transition cursor-pointer"
              >
                Reset All Progress
              </button>
            )}
