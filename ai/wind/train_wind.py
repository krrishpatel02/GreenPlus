...
MODEL_FILE = ROOT / "wind_model.joblib"
METRICS_FILE = ROOT / "wind_model_metrics.json"
DATA_FILE = ROOT / "wind_dataset.csv"
FEATURES = ["temperature_2m", "relative_humidity_2m", "cloud_cover", "pressure_msl", "hour", "day_of_year"]
