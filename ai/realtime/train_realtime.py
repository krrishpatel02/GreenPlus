...
MODEL_FILE = ROOT / "realtime_solar_model.joblib"
METRICS_FILE = ROOT / "realtime_model_metrics.json"
DATA_FILE = ROOT / "realtime_weather_dataset.csv"
RANDOM_STATE = 42
FEATURES = [
    "temperature_2m",
